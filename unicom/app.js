...
const PROV_MIGRATED_KEY = "lt_prov_migrated_v2";
...
(function () {
  ...
  var css = [
    ...
    ".notice-top{background:linear-gradient(120deg,#e60012,#ff6a6a);color:#fff;padding:18px 20px 14px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}",
    ...
    ".notice-ok{border:0;background:linear-gradient(120deg,#e60012,#ff6a6a);color:#fff;font-size:14px;padding:9px 26px;border-radius:20px;cursor:pointer;font-weight:500;box-shadow:0 4px 12px rgba(0,0,0,.14)}",
